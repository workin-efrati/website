    ...
    return (
        <div className="flex items-center gap-3 flex-wrap" dir="rtl">
            ...
            <button
                ...
                className="group cursor-pointer relative inline-flex items-center gap-2.5 px-6 py-3 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white font-semibold rounded-xl transition-all duration-300 shadow-lg shadow-green-500/30 hover:shadow-xl hover:shadow-green-500/40 hover:scale-[1.02] active:scale-[0.98]"
            ...
            >
                ...
                <span className="hidden md:block z-10 text-sm md:text-base">שתף בוואטסאפ</span>
            ...
            <button
                ...
                onMouseLeave={() => setIsHovering(null)}
                className={`group cursor-pointer relative inline-flex items-center gap-2.5 px-6 py-3 font-semibold rounded-xl transition-all duration-300 shadow-md hover:shadow-lg hover:scale-[1.02] active:scale-[0.98] ${copied
                ...
                <div className="relative z-10 flex items-center gap-2.5">
                    {copied ? (
                        <>
                            ...
                            <span className="text-sm md:text-base font-semibold">הועתק בהצלחה!</span>
                        </>
                    ) : (
                        <>
                            <Link2 className="w-5 h-5 transition-transform duration-300 group-hover:rotate-45" />
                            <span className="text-sm md:text-base">העתק קישור</span>
                        </>
                    )}
                </div>
