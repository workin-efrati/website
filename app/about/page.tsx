               ...
               <CardContent className="p-8 md:p-12 text-right">
                  ...
                  <div className="prose prose-lg dark:prose-invert max-w-none text-muted-foreground leading-loose">
                     <p className="text-xl font-medium text-foreground">
                        אתר זה נבנה במיוחד כדי לרכז ולהנגיש את אוצר השאלות והתשובות של הרב ברוך אפרתי, שנצבר לאורך שנים של עשייה ברוכה.
                     </p>
                     <p>
                        במשך זמן רב, השיב הרב לאלפי פניות בנושאים מגוונים – החל מהלכות יום-יום ועד לסוגיות אקטואליות מורכבות – הן באופן פרטי והן בקבוצות ייעודיות.
                        הידע העצום הזה, שהיה עד כה נחלתם של יחידים, עבר תהליך מקיף של עריכה וסידור על ידי צוות מסור של מתנדבים.
                     </p>
                     <p>
                        מטרתנו היא אחת: <strong>להנגיש מידע תורני מדויק ואמיתי לכל דורש, בכל רגע נתון.</strong> אנו רואים באתר זה כלי להפצת תורה ומצוות, ומקווים שיהיה לעזר ולתועלת לכל המבקש את דבר ה'.
                     </p>
                  </div>
               </CardContent>
            </Card>
